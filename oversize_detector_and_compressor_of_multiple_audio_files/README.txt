SCRIPT: scan_detect_perform_compressions.py 
Can be used for scanning detecting and compressing audio files which are oversized.


THIS PYTHON SCRIPTS REQUIRES FFMPEG LIBRARY
